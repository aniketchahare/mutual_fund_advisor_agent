...
from .sub_agents.investmentAgent.agent import investment_agent # NEW IMPORT: Ensure the InvestmentAgent is imported
...
root_agent = Agent(
    ...
    * **Tracking Progress:** Explicitly update `session.state["current_agent_status"]` to track the current stage of the conversation, the agent currently active, and potentially the next expected input from the user. This helps in maintaining internal consistency and provides better debugging visibility.
    ...
    **Important Note:**
    ...
    sub_agents=[
        ...
        investment_agent, # Ensure this is included as it's part of the end-to-end flow.
    ],
