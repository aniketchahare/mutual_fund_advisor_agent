"""
Fund Validation Agent

This agent validates if there are new mutual funds to show to the user.
It accepts the list of all funds and the list of shown fund IDs, and responds with either the new funds or a message that no new funds are available.
"""
